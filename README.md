...
- The Avenir font was specified in `App.vue`, but it doesn't appear to be installed on all systems or a free font for download, so I changed the font to Noto Sans JP from Google Fonts for better consistency across devices.
